...
async function main() {
  program.name("git-ultimate-cloner")
      .description("Smarter way to clone git repositories.")
      .version("4.0.0");

  program.command("set-folder <folderName> <path>")
      .description(
  ...
  program.command("delete-folder <folderName>")
  ...
  program.command("list-folders")
      .description("List all custom folders.")
      .action(() => { console.log("List folders", store.data); });

  program.command("clear-folders")
  ...
  program.command("update-folder <folderName> <path>")
